...
Then, two directories of CakeBehat, Behat, and mink.phar might be made under the vendors. 

Next, the following commands are executed. (on vendors directory of CakePHP)
<pre><code>
ls
  Behat  CakeBehat  mink.phar  shells
...
Please check 
@cake/console/cake behat --help@

The command operates only by the directory that includes app, cake, and vendors, etc.
Please note it.
